# PSE Pulse frontend forecast-data contract
...
Legacy `forecastph.*` schema identifiers are stable machine-readable contract identifiers and are intentionally retained after the PSE Pulse public rebrand.
