...
export const metadata: Metadata = {
  title: "PSE Pulse | Philippine Stock Forecasting",
  description: "PSE Pulse provides educational Philippine stock price forecasts generated by an automated ML pipeline.",
};
